...
"""
    ...
    word_not_found = """عذراً لم يتم التعرف على المتجر المدخل

يرجى التأكد من كتابة الأسم بشكل صحيح

أو إختيار المتجر من قائمة المتاجر
كما يمكنك التواصل مع الدعم لنجد لك كود الخصم المناسب بأسرع وقت @daleel_support
